...
def generate_launch_description():
    ...
    declare_world_cmd = DeclareLaunchArgument(
        'world',
        default_value=os.path.join(bringup_dir, 'worlds/sweep', 'world.model'),
        description='Full path to world model file to load')

    declare_robot_sdf_cmd = DeclareLaunchArgument(
        'robot_sdf',
        default_value=os.path.join(bringup_dir, 'worlds/sweep', 'sweep.model'),
    ...
    urdf = os.path.join(bringup_dir, 'urdf', 'robot.urdf')
