...
def generate_launch_description():
    ...
    bringup_cmd_group = GroupAction([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(launch_dir, 'modulab_webaction_proxy_launch.py'))),


        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(launch_dir, 'modulab_save_bitmaps_launch.py'))),


        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(launch_dir, 'modulab_compass_launch.py'))),
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={'autostart': 'false',
                              'params_file': params_file,
                              'use_lifecycle_mgr': 'false',
                              'map_subscribe_transient_local': 'true'}.items()),
        ...
        Node(
            package='modulab_slam_monitor_py',
            executable='modulab_slam_monitor',
            name='modulab_slam_monitor_py',
            output='screen'
            ),
